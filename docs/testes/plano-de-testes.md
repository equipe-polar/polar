...
| T03 | Registro completo de ocorrência | Professor registra com aluno, categoria, prioridade e descrição | 201; status `REGISTRADA`; autor/data automáticos; histórico com 1 entrada | Ocorrência registrada com sucesso, sendo adicionada corretamente ao histórico. | PH Barros | 05/08/2026 | docs\testes\Evidências\T03.jpeg |
| T04 | Registro incompleto | Omitir aluno; depois descrição < 10 chars | 400 em ambos; nada gravado | Sistema impediu o registro quando os campos obrigatórios não foram preenchidos. | PH Barros | 05/08/2026 | docs\testes\Evidências\T04.jpeg |
...
| T06 | Transição válida pela coordenação | Coordenador: `REGISTRADA→EM_ANALISE→RESOLVIDA` com observação | 200; histórico ganha entradas com autor e observação | Funcionalidades básicas operacionais, porém o fluxo apresentou divergências do especificado. | PH Barros | 05/08/2026 | docs\testes\Evidências\T06.jpeg |
...
| T09 | Acesso sem autenticação | Chamar `/ocorrencias` sem token | 401 | Após o reinício do serviço, a ocorrência e seu respectivo histórico permaneceram armazenados corretamente, confirmando a persistência dos dados. |  PH Barros | 05/08/2026 | docs\testes\Evidências\T09.jpeg |
